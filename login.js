...
function Login(form) {
username = new Array("beastman733","mywhitevan","awesomesauce5","jg","emma","izzy","theo","u8","u9","u10");
password = new Array("MONOCORNS","weezer","weatherbugs","christian","necktie","music","skate","p8","p9","p10");
page = "hahahahahahahahahahahahahahaha" + "/";
...
alert("Go away Connor your not welcome here");
form.username.focus();
}
return true;
}
